<template>
  <div class="card floating" style="max-width: 40em;">
    ...
    <div class="card-content">
      ...
      <div ref="hideable"
           style="display: inline-block; margin-left: 10px; vertical-align: top; transition: opacity .6s;">
        <label>Overwrite:
  ...
  <div class="card floating" style="max-width: 80vw;" :hidden="isHelpHidden">
    <div class="card-title"><h2>m2ledmac commandline help</h2>
  ...
  methods: {
    ...
    mauro_m2ledmac: async function (event) {
      ...
      const action = async (overwrite, rename) => {
        ...
        await api
            .mauro("m2ledmac", item, encodeURIComponent(this.commandline), rename)
            .then(() => {
    ...
    mauro_m2ledmac_help: async function (event) {
